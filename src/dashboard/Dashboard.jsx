      ...
      <div className="p-4 mt-4 bg-white shadow-md">
        ...
        {user && (
          <div className="pt-1">
            ...
            <div className="text-red-900"><span className="font-bold">Username:</span> {user.username}</div>
            <div className="text-red-900"><span className="font-bold">Email:</span> {user.email}</div>
            <div className="text-red-900"><span className="font-bold">Phone:</span> {user.phone_number}</div>
          </div>
        )}
      </div>
    </div>
